...
Revision ID: 5ab2b24501a4
Revises: 4730cedc5b04
Create Date: 2025-05-04 15:56:10.603189
...
revision: str = '5ab2b24501a4'
down_revision: Union[str, None] = '4730cedc5b04'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['order_id'], ['order.id'], name='delivery_order_id_fkey'),
